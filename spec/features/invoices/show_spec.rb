...
RSpec.describe 'invoices show' do
  before :each do
    ...
    @bulk_discount_1 = @merchant_1.bulk_discounts.create!(discount_percent: 15, threshold: 10)
  ...
  describe "displaying revenue" do
    before(:each) do
      visit merchant_invoice_path(@merchant_1, @invoice_1)
    end
    it 'displays the total merchant revenue for an invoice, and the revenue after discounts' do
      within("#revenues") do
